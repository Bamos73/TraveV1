...
class PanierOrder extends StatefulWidget {
  const PanierOrder({Key? key, required this.CodeCommande}) : super(key: key);
  final String CodeCommande;

  @override
  _PanierOrderState createState() => _PanierOrderState();
}

class _PanierOrderState extends State<PanierOrder> {
                      ...
                      GestureDetector(
                        ...
                        child: StreamBuilder<QuerySnapshot>(
                          stream: FirebaseFirestore.instance
                              ...
                              .collection(widget.CodeCommande)
                              .doc(widget.CodeCommande)
                              .collection('Articles')
                              .snapshots(),
